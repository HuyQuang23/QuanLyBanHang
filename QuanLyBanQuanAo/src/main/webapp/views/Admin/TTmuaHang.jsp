...
<section>
    <header>
        ...
        <p><a href="/account/login">Đăng xuất</a></p>
...
<table border="1" class="table table-striped table-hover" style="width:100%">
    ...
    <tbody>
    <c:forEach var="item" items="${LS.content}">
            <tr>
                    <td>${item.id}</td>
                    <td>${item.account.fullname}</td>
                    <td>${item.createDate}</td>
                <td>
                    <a class="btn btn-outline-danger" href="view-chitiet/${item.id}">Chi Tiết</a>
                </td>
            </tr>
    </c:forEach>
    </tbody>
...
<div class="center">
    <div class="pagination">
        <a href="/admin?p=0">&laquo;</a>
        <a href="/admin?p=${LS.number-1}">1</a>
        <a href="/admin?p=${LS.number+1}">2</a>
        <a href="/admin?p=${LS.totalPages-1}">&raquo;</a>
    </div>
</div>
