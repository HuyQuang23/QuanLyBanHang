...
<a class="btn btn-outline-primary" href="/catecory/create" methods="get">ViewAdd</a>
<table border="1" class="table table-striped table-hover" style="width:100%">
    ...
    <tbody>
    <c:forEach var="item" items="${categoryeis.content}">
        <tr>
            <td>${item.id}</td>
            <td>${item.name}</td>
            <td>
                <a class="btn btn-outline-danger" href="/catecory/update/${item.id}">Update</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
...
<div class="center">
    <div class="pagination">
        <a href="/catecory/index?p=0">&laquo;</a>
        <a href="/catecory/index?p=${categoryeis.number-1}">1</a>
        <a href="/catecory/index?p=${categoryeis.number+1}">2</a>
        <a href="/catecory/index?p=${categoryeis.totalPages-1}">&raquo;</a>
    </div>
</div>
